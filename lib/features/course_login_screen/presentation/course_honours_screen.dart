...
class CourseHonoursLoginScreen extends StatefulWidget {
  const CourseHonoursLoginScreen({
    super.key,
  });

  @override
  State<CourseHonoursLoginScreen> createState() =>
      _CourseHonoursLoginScreenState();
}

class _CourseHonoursLoginScreenState extends State<CourseHonoursLoginScreen> {
  ...
  void initState() {
    super.initState();
    _getDeviceInfo();
    log("=======> Honours: ${appData.read(kKeyHonours)}");
  }
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      'আপনাকে আমাদের কোর্স দেখতে হলে আপনাকে লগইন করতে হবে।',
