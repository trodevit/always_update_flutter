...
class HscLoginScreen extends StatefulWidget {
  dynamic yearID;
  HscLoginScreen({
    super.key,
    this.yearID,
  ...
  @override
  State<HscLoginScreen> createState() => _HscLoginScreenState();
}

class _HscLoginScreenState extends State<HscLoginScreen> {
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      'আপনাকে আমাদের এইচএসসি কোর্স দেখতে হলে আপনাকে লগইন করতে হবে।',
                          ...
                          isLoading // If the loading state is true, show loading
                              ...
                              : customButton(
                                  ...
                                  onCallBack: () async {
                                    ...
                                    if (success) {
                                      if (courseLoginRX
                                              .dataFetcher.value.user?.hsc ==
                                          1) {
                                        if (widget.yearID == widget.yearID) {
