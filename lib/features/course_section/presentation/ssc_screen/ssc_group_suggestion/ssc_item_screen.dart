...
class SscItemScreen extends StatefulWidget {
  dynamic type, className;
  SscItemScreen({super.key, this.type, this.className});

  @override
  State<SscItemScreen> createState() => _SscItemScreenState();
}

class _SscItemScreenState extends State<SscItemScreen> {
  @override
  void initState() {
    super.initState();
    sscGroupSuggestionRX.groupSuggestionRX(type: widget.type);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<SscGroupSubjectModel>(
          stream: sscGroupSuggestionRX.getGroupSuggestionRx,
