...
class SscAllPdfSubjectSingleItemScreen extends StatefulWidget {
  dynamic type, classType, itemID, subjectTitle;
  SscAllPdfSubjectSingleItemScreen({
    super.key,
    this.type,
    this.classType,
    this.itemID,
  ...
  @override
  State<SscAllPdfSubjectSingleItemScreen> createState() =>
      _SscAllPdfSubjectSingleItemScreenState();
}

class _SscAllPdfSubjectSingleItemScreenState
    extends State<SscAllPdfSubjectSingleItemScreen> {
  @override
  void initState() {
    super.initState();
    sscPDFSubjectSingleItemRX.getPDFSubjectSingleItemRX(
      type: widget.type,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<SscPdfSubjectSingleItemModel>(
          stream: sscPDFSubjectSingleItemRX.getGetPDFSubjectSingleItemRx,
